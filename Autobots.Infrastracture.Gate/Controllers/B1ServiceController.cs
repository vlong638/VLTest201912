...
namespace Autobots.Infrastracture.Gateway.Controllers
{
    ...
    public class B1ServiceController : ControllerBase
    {
        ...
        /// <returns></returns>
        [HttpPost]
        public async Task<APIResult<HelloReply>> SayHello([FromServices] IOptions<ServiceDisvoveryOptions> serviceConfig, [FromServices] B1ServiceRPCClientProvider provider, HelloRequest request)
        {
