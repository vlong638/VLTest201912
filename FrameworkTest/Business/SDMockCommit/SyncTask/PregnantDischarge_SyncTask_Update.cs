...
//{
//    public class PregnantDischargeModel_SyncTask_Update : SyncTask<PregnantDischargeModel_SourceData>
//    {
//        public PregnantDischargeModel_SyncTask_Update(ServiceContext context) : base(context)
//        {
//        }

//        public override List<PregnantDischargeModel_SourceData> GetSourceDatas(UserInfo userInfo)
//        {
//            return Context.PregnantService.GetPregnantDischargesToUpdate().Select(c => new PregnantDischargeModel_SourceData(c)).ToList();
//        }

//        public SyncOrder DoCommit(WCQBJ_CZDH_DOCTOR_READResponse base8, UserInfo userInfo, PregnantDischargeModel_SourceData sourceData, StringBuilder logger)
//        {
...
//        public override void DoWork(ServiceContext context, UserInfo userInfo, PregnantDischargeModel_SourceData sourceDataModel)
//        {
//            StringBuilder logger = new StringBuilder();
//            var syncOrder = Context.PregnantService.GetSyncOrder(TargetType.PregnantDischarge, sourceDataModel.SourceId);
...
//                }
//                //更新数据
//                var PregnantDischargeToUpdate = new WMH_CQBJ_CQJC_SAVE(PregnantDischargeOld);
//                PregnantDischargeToUpdate.Update(userInfo, sourceDataModel, highRisksToSave);
//                //提交专科检查
//                var isSuccess = Context.FSService.UpdatePregnantDischarge(physicalExaminationId, PregnantDischargeToUpdate, userInfo, base8, ref logger);
//                if (!isSuccess)
//                {
//                    syncOrder.SyncStatus = SyncStatus.Error;
