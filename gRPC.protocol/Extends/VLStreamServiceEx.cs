...
namespace VLStreamService
{
    ...
    /// </summary>
    public static class VLStreamServiceEx
    {
        public const string DefaultFeaturesResourceName = "gRPC.protocol.route_guide_db.json";
        ...
        {
            var stream = typeof(VLStreamServiceEx).GetTypeInfo().Assembly.GetManifestResourceStream(DefaultFeaturesResourceName);
            if (stream == null)
            {
