/*
 ...
 Source Host           : 192.168.50.102:1433
...
CREATE TABLE [dbo].[PREGNANTINFO] (
  ...
  [sexcode] char(1) COLLATE Chinese_PRC_CI_AS  NULL,
  ...
  [pasthistory] varchar(1000) COLLATE Chinese_PRC_CI_AS  NULL,
  ...
  [editorcode] varchar(200) COLLATE Chinese_PRC_CI_AS  NULL,
  [editorname] varchar(200) COLLATE Chinese_PRC_CI_AS  NULL,
  [pulse] int  NULL,
  [dateofprenatalflag] int DEFAULT ((0)) NULL,
  [lastmodifydate] datetime  NULL,
  [create_localuser] varchar(200) COLLATE Chinese_PRC_CI_AS  NULL,
  ...
  [deliveryid] varchar(500) COLLATE Chinese_PRC_CI_AS  NULL,
  ...
  [personnalhistory] varchar(100) COLLATE Chinese_PRC_CI_AS  NULL,
  ...
  [husbandbloodtypecode] varchar(50) COLLATE Chinese_PRC_CI_AS  NULL,
  [husbandrhbloodcode] varchar(50) COLLATE Chinese_PRC_CI_AS  NULL,
  [createbookunit] varchar(50) COLLATE Chinese_PRC_CI_AS  NULL,
  [bloodtransfution] varchar(100) COLLATE Chinese_PRC_CI_AS  NULL,
  [eggretrievaltime] datetime  NULL,
  [implanttime] datetime  NULL
)
GO
...
EXEC sp_addextendedproperty
'MS_Description', N'输血史',
'SCHEMA', N'dbo',
'TABLE', N'PREGNANTINFO',
'COLUMN', N'bloodtransfution'
GO

EXEC sp_addextendedproperty
'MS_Description', N'取卵时间',
'SCHEMA', N'dbo',
'TABLE', N'PREGNANTINFO',
'COLUMN', N'eggretrievaltime'
GO

EXEC sp_addextendedproperty
'MS_Description', N'植入时间',
'SCHEMA', N'dbo',
'TABLE', N'PREGNANTINFO',
'COLUMN', N'implanttime'
GO

EXEC sp_addextendedproperty
'MS_Description', N'孕妇档案',
'SCHEMA', N'dbo',
'TABLE', N'PREGNANTINFO'
GO
